...
class CreateRequest extends Component {
    ...
    render() {
        ...
        const enClass = this.state.isEnglish ?  classes.activeMenuButton : classes.menuButton 
        const arClass = !this.state.isEnglish ?  classes.activeMenuButton : classes.menuButton;
        return (
            <div style={{ backgroundColor: '#F9F9F9', width: '100%' }}>
                <div className={classes.root} >

                    <div style={{ display: 'flex', direction: 'rtl', width: '30%', margin: '10px auto' }}>
                    ...
                    <Grid container spacing={24} style={{ justifyContent: 'center' }}>
                        ...
                        {this.state.isEnglish &&
                            <RequestForm
                                handleCreateRequest={this.props.createRequest}
                            />
                        }
...
export default connect(null, mapDispatchToProps)(withStyles(styles)(CreateRequest))
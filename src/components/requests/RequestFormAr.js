            ...
            <Grid item className={classes.root} xs={12} sm={8} md={8} lg={5}>
                ...
                { !this.state.showThanks && <div>
                    ...
                    <Grid container className={classes.dataContainer}>
                        <label style={{ fontSize: '24px' }}>العنوان الأصلي للفيلم:</label>
                        <TextField
                    ...
                    <Grid container className={classes.dataContainer}>
                        <label style={{ fontSize: '24px' }}>السيرة الذاتية للمخرج:</label>
                        <TextField
                            multiline
                            className={classes.textField}
                    ...
                    <Grid container className={classes.dataContainer}>
                        <label style={{ fontSize: '24px' }}>البريد الالكتروني للمخرج:</label>
                        <TextField
                            className={classes.textField}
                    ...
                    <Grid container className={classes.dataContainer}>
                        <label style={{ fontSize: '24px' }}>رقم موبايل (مع الكود):</label>
                        <TextField
                            className={classes.textField}
                    ...
                    <Grid container className={classes.dataContainer}>
                        <label style={{ fontSize: '24px' }}>Vimeo/Dropbox رابط الفيلم:</label>
                        <TextField
                            className={classes.textField}
                    ...
                    <Grid container className={classes.dataContainer}>
                        <label style={{ fontSize: '24px' }}>كلمة المرور (إن وُجدت):</label>
                        <TextField
                            className={classes.textField}
